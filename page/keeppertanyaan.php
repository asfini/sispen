                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="<?php echo $data['jumlah'] ?>">
                                        <a href="#" class="btn btn-primary btn-flat btn-xs" data-toggle="modal" data-target="#updatepertanyaan<?php echo $data['id']; ?>"><i class="fa fa-pencil"></i> Edit</a>
                                        <a href="#" class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#deletepertanyaan<?php echo $data['id']; ?>"><i class="fa fa-trash"></i> Delete</a>
